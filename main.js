...
//API de lista de paises
var config = {
    cUrl: 'https://api.countrystatecity.in/v1/countries',
    apiKey: 'S0lUNm1mRzdqWWdROVF1bVIxc3FtRnNKVnFGMUZjQ3hKSFV3bEtMZA=='
}
...
function loadCountries(){
    ...
    fetch(apiEndPoint, {headers: {"X-CSCAPI-KEY": config.apiKey}})
...
function validarDatos() {
    ...
    if (!regexTexto.test(nombre) || !regexTexto.test(apellido)) {
        Swal.fire({
            position: "center",
            icon: "warning",
            title: "El nombre y apellido solo puede contener letras y espacios!",
...
// Vaida datos
if (!validarDatos()) {
    return; // Si los datos no son válidos, termina la ejecución de la función
}
